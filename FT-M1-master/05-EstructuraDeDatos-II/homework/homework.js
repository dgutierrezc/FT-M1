...
Implementar la clase LinkedList, definiendo los siguientes métodos:
  ...
  - search: recibe un parámetro y lo busca dentro de la lista, con una
   particularidad: el parámetro puede ser un valor o un callback. 
...
LinkedList.prototype.remove = function(){
  ...
  if(this.head.next === null){
    ...
    var devolverValor  = current.next.value;
    current.next = null;
...
La clase debe tener los siguientes métodos:
  ...
  alfabético, suma el código numérico de cada caracter del input (investigar el método charCodeAt 
    de los strings) y calcula el módulo de ese número total
     por la cantidad de buckets; de esta manera determina la posición de la tabla en la 
